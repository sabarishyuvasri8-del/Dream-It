                ...
                return (
                  ...
                  >
                    <div className="relative flex items-center max-w-[70%]">
                      ...
                      <div 
                        className={`rounded-2xl px-5 py-3.5 text-[20px] leading-relaxed shadow-sm flex flex-col gap-2 max-w-[90%] md:max-w-[85%] break-words whitespace-pre-wrap ${isMe ? 'rounded-tr-sm' : 'rounded-tl-sm'}`}
                        style={{ 
